...
**Home & energy** — **Tempo colour** (EDF's blue/white/red electricity tariff as a full-tile band readable across the room, tomorrow's colour once published, remaining days per colour; correctly handles the 6am-to-6am Tempo day), **Home Assistant** (read-only view of your entities — room temperatures, open doors, consumption — updated live over WebSocket; calls no service and cannot change anything in your home), **Bambu Lab 3D printer** (live progress, current stage, estimated finish time, bed/nozzle/chamber temperatures, AMS spools and humidity, HMS errors — over your local network or your Bambu account; read-only, it never sends a command to the printer, and the display degrades as the tile shrinks down to progress alone).
...
**Maison & énergie** — **couleur Tempo** (l'offre bleu/blanc/rouge d'EDF en bandeau pleine tuile lisible de loin, couleur du lendemain dès publication, jours restants par couleur ; gère correctement la journée Tempo de 6 h à 6 h), **Home Assistant** (vue en lecture seule de vos entités — températures des pièces, portes ouvertes, consommation — mise à jour en direct par WebSocket ; n'appelle aucun service et ne peut rien changer chez vous), **imprimante 3D Bambu Lab** (avancement en direct, étape en cours, heure de fin prévue, températures plateau/buse/caisson, bobines et humidité des AMS, erreurs HMS — par le réseau local ou par le compte Bambu ; lecture seule, la tuile n'envoie aucune commande à l'imprimante, et l'affichage se dégrade en rétrécissant jusqu'à ne garder que l'avancement).
