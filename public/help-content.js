...

    {
      ...
      html: {
        fr: `
          ...
          <div class="help-opt"><span class="help-opt-name">Trajets supplémentaires 1 à 5</span><span class="help-opt-desc">Chacun avec un nom, une adresse de destination, et sa propre heure d'arrivée souhaitée optionnelle. Un emplacement sans nom ou sans adresse est simplement ignoré ; l'échec du calcul d'un trajet n'empêche pas l'affichage des autres.</span></div>`,
        en: `
          ...
          <div class="help-opt"><span class="help-opt-name">Extra trips 1 to 5</span><span class="help-opt-desc">Each with a name, a destination address, and its own optional desired arrival time. A slot with no name or no address is simply skipped; a failed trip calculation doesn't prevent the others from showing.</span></div>`
      }
    },
