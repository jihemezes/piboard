...

    {
      ...
      html: {
        fr: `
          ...
          <div class="help-opt"><span class="help-opt-name">Afficher les images distantes</span><span class="help-opt-desc">Désactivé par défaut : une simple image distante de 1×1 suffit à confirmer à l'expéditeur que le message a été ouvert (c'est le principe d'un pixel espion). Les images déjà intégrées au message (un logo, une signature) s'affichent toujours, quel que soit ce réglage — elles ne chargent rien depuis l'extérieur.</span></div>
