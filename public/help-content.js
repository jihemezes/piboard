    ...
    },
    {
      ...
      html: {
        fr: `
          ...
          <p><b>Le plus simple est de recadrer directement sur l'image</b> : dès que vous passez en <b>mode édition</b>, quatre poignées d'angle et une petite barre d'outils apparaissent sur la tuile, quel que soit le cadrage choisi. Glissez sur l'image pour la déplacer dans son cadre, tirez l'un des quatre angles en diagonale pour zoomer. Une petite barre affiche le zoom courant, avec deux boutons pas à pas et une remise à zéro. Le résultat s'affiche <b>pendant</b> le geste ; l'enregistrement n'a lieu qu'au relâchement. Les champs numériques des réglages restent utiles pour poser une valeur exacte ou reproduire à l'identique le recadrage d'une autre tuile.</p>
        ...
        en: `
          ...
          <p><b>The easiest way is to crop directly on the image</b>: as soon as you enter <b>edit mode</b>, four corner handles and a small toolbar appear on the tile, whatever the chosen framing. Drag on the image to move it within its frame, pull one of the four corners diagonally to zoom. A small bar shows the current zoom, with two step buttons and a reset. The result appears <b>while</b> you drag; saving only happens on release. The numeric fields in the settings remain useful to set an exact value or to reproduce another tile's crop identically.</p>
