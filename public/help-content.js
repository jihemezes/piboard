...

    {
      ...
      html: {
        fr: `
          ...
          <p>Le contenu des messages est <b>désinfecté avant affichage</b> : les scripts sont retirés et les images distantes remplacées par une mention — leur chargement confirmerait sinon à l'expéditeur que le message a été ouvert.</p>
        ...
        en: `
          ...
          <p>Message content is <b>sanitized before display</b>: scripts are removed and remote images replaced by a note — loading them would otherwise confirm to the sender that the message was opened.</p>
