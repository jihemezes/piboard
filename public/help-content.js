...

    {
      ...
      html: {
        fr: `
          ...
          <h4>Options</h4>
          <div class="help-opt"><span class="help-opt-name">Adresse A / Adresse B</span><span class="help-opt-desc">Les deux extrémités du trajet principal. Se valide en direct pendant la saisie (recherche après une courte pause) : une confirmation verte affiche l'adresse complète telle que comprise, ou un message rouge si elle est introuvable — plus besoin d'attendre un « itinéraire indisponible » pour savoir si l'adresse posait problème.</span></div>
          ...
          <div class="help-opt"><span class="help-opt-name">Trajets supplémentaires 1 à 5</span><span class="help-opt-desc">Chacun avec un nom, une adresse de destination (même validation en direct que ci-dessus), et sa propre heure d'arrivée souhaitée optionnelle. Un emplacement sans nom ou sans adresse est simplement ignoré ; l'échec du calcul d'un trajet n'empêche pas l'affichage des autres.</span></div>`,
        en: `
          ...
          <h4>Options</h4>
          <div class="help-opt"><span class="help-opt-name">Address A / Address B</span><span class="help-opt-desc">The two ends of the main trip. Validates live as you type (searches after a short pause): a green confirmation shows the full address as understood, or a red message if it can't be found — no more waiting for a "route unavailable" message to find out the address itself was the problem.</span></div>
